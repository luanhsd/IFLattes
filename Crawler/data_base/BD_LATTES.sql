...
CREATE TABLE IF NOT EXISTS `fat_atuacao` (
  ...
  `vinculo_empregaticio` TINYINT(1) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `fat_producao` (
  ...
  `pagina` INT NULL COMMENT '',
  `keywords` VARCHAR(45) NULL COMMENT '',
  `url` VARCHAR(255) NULL COMMENT '',
  `tipo` VARCHAR(45) NULL COMMENT '',
  `serie` VARCHAR(45) NULL COMMENT '',
  `issn_isbn` VARCHAR(45) NULL COMMENT '',
  `divisao` VARCHAR(45) NULL COMMENT '',
  `areas` BLOB NULL COMMENT '',
